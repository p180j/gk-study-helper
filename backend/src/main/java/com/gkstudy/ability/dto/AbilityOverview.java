...
public class AbilityOverview {
    ...
    private final int assessingCount;
    private final int totalCount;
    private final int coveragePercent;
    private final List<AbilityProfile> abilities;

    public AbilityOverview(int evaluatedCount, int assessingCount, int totalCount, List<AbilityProfile> abilities) {
        this.evaluatedCount = evaluatedCount; this.totalCount = totalCount;
        this.assessingCount = assessingCount;
    ...
    public int getAssessingCount() { return assessingCount; }
