...
@RestControllerAdvice public class GlobalExceptionHandler {
 ...
 @ExceptionHandler(IllegalArgumentException.class) @ResponseStatus(HttpStatus.BAD_REQUEST) public ApiResponse<Void> illegalArgument(IllegalArgumentException e){return ApiResponse.failure("INVALID_ARGUMENT",e.getMessage());}
